...
public class SupplierDAOimpl implements SupplierDAO {
    ...
    public void insert(Supplier entity) {
        String sql = """
            INSERT INTO Suppliers (Supplier_id, address, city, company_name, contact_name, contact_title, country, fax, homepage, phone, postal_code, region)
            VALUES (?,?,?,?,?,?,?,?,?,?,?,?)
            """;
...
//         -> requete preparee
        ...
        try(
            ...
            stmt.setString(9, entity.getHomepage());
            stmt.setString(10, entity.getPhone());
            stmt.setString(11, entity.getPostalCode());
            stmt.setString(12, entity.getRegion());
    ...
    public List<Supplier> getAll() {
        ...
        try (
            ...
            while (rs.next()) {
                l.add(Converter.convert(rs, Supplier.class));
            }
            return l;
        } catch (SQLException e) {
    ...
    public void update(Long id, Supplier entity) {
        ...
        try(
            ...
            stmt.setString(8, entity.getHomepage());
